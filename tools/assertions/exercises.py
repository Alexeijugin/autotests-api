...
def assert_create_exercise_response(request: CreateExerciseRequestSchema, response: CreateExerciseResponseSchema):
    """
    Проверяет, что ответ создание задания соответствует данным из запроса.
...
def assert_exercise(actual: ExerciseSchema, expected: ExerciseSchema):
    ...
    :param excepted: Ожидаемые данные задания.
    :raises AssertionError: Если хотя бы одно поле не совпадает.
    """
...
def assert_exercise_not_found_response(actual: InternalErrorResponseSchema):
    """
    Функция для проверки ошибки, если задание на найдено на сервере.
...
def assert_get_exercises_response(
    ...
    """
    Проверяет, что ответ на получения списка заданий соответствует ответам на их создание.
    :param get_exercises_response:
    :param create_exercise_responses:
    :return:
    """
