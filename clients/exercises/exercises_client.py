...
class CreatExerciseRequestDict(TypedDict):
    """
...
class ExercisesClient(APIClient):
    ...
    def create_exercise_api(self, request: CreatExerciseRequestDict) -> Response:
        """
    ...
    def create_exercise(self, request: CreatExerciseRequestDict) -> CreateExerciseResponseDict:
