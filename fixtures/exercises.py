...
from clients.exercises.exercises_schema import CreatExerciseRequestSchema, CreateExerciseResponseSchema
from fixtures.courses import CourseFixture
from fixtures.users import UserFixture

class ExercisesFixture(BaseModel):
    request: CreatExerciseRequestSchema
...
def function_exercise(exercises_client: ExercisesClient, function_course: CourseFixture) -> ExercisesFixture:
    request = CreatExerciseRequestSchema(course_id=function_course.response.id)
